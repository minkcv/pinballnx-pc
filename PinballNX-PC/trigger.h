...
class Trigger {
    public:
        Trigger(SceneElement* root, b2World& world, int triggerID, int layerID, int behavior, int delay, OptWall* wallToChange = nullptr, OptWall* wall2 = nullptr, OptWall* wall3 = nullptr, OptWall* wall4 = nullptr);
    ...
    private:
		...
		SceneElement* m_eltEnabled;
		SceneElement* m_eltDisabled;
